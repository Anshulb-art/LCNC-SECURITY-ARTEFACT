...
2. **SAST (Automated)** — scan with SonarQube; export screenshots + 3–5 bullet summary to `Input and Output folder/<App>/SAST/`.
3. **DAST–Active (Automated)** — run ZAP full/active scan; save `zap-active-<app>.html` to `Input and Output folder/<App>/DAST/`.
4. **DAST–Passive (Manual)** — browse and observe headers/cookies/routes; save screenshots + notes to `Input and Output folder/<App>/DAST/passive/`.
